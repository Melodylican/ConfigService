...
<body>
	...
	<div class="mainWrap clearfix">
		...
		<div class="colMain">
			<div class="crumb">
				<span>当前位置：</span> <strong>配置管理 <c:if
			...
			<div class="wrap">
				<div class="grid">
					<form id="Form" action="<%=request.getContextPath()%>/promoter/saveupdate"  modelAttribute="promoterBean,redeemCodeBean,integralSchemeBean" method="POST">
								...
								<c:choose>
									<c:when test="${not empty promoterBean.endDesc}">
										<textarea name="endDesc"
											style="width:350px;height:180px;padding:5px;border:1px solid #c9c9c9;color:#666;"
						...
						<fieldset
							...
							<p>
								<label>推广员时间要求</label> <input id="promoterATime" type="number" name="promoterATime" value="${integralSchemeBean.promoterATime }" style="width: 60px"min="0" > <label>小时</label>
                        ...
                        <br>
						<fieldset
							style="border-width: 2px; border-color: #008000; width:95%; height:450">
							...
							<p>
                               ...
                               <!-- <textarea name="shareMethod" hidden="hidden" readonly="readonly" value="${redeemCodeBean.shareMethod }"  id="shareMethod" >
                               </textarea>  -->
							</p>
							<p>
								<label>活动方案简述</label>
								<c:choose>
									<c:when test="${not empty redeemCodeBean.redeemDesc}">
										<textarea name="redeemDesc"
											style="width:350px;height:183px;padding:5px;border:1px solid #c9c9c9;color:#666;"
	...
	<script type="text/javascript">
	    ...
	    $(document).ready(function () {
	        validator1 = $("#Form").validate({
	            ...
	            messages: {
	                ...
	                rechargeA: {
	                	required: '请输B充值后A获得的奖励积分'
	                },
	                rechargeB: {
	                	required:  '请输B充值后B获得的奖励积分'
	                }
	            },
	    ...
	    $("input.gameType").each(function(){//给所有的input绑定事件
	      	 $(this).click(function(){
	      		 ...
	      		 //将所有的选中的值存放l
	      		 $("#shareMethod").val(l.join(","));//将数据值联合字符串给显示对象附值
	      		});
	    });
	    */
	</script>
