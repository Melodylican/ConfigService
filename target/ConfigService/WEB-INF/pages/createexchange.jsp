		...
		<div class="colMain">
			<div class="crumb">
				<span>当前位置：</span> <strong>积分兑换配置 <c:if
						test="${not empty insertMsg}">
						<h1>
							<font color="red">${insertMsg}</font>
						</h1>
					</c:if></strong>
			</div>
			<div class="wrap">
				<div class="grid">
					<form id="Form" action="<%=request.getContextPath()%>/exchange/savecreate" modelAttribute="exchBean" method="POST">
						<p id="info"></p>
						<p>
