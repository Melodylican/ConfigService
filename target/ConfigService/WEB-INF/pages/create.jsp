...
<body>
	...
	<div class="mainWrap clearfix">
		...
		<div class="colMain">
			...
			<div class="wrap">
				<div class="grid">
					<form id="Form" action="<%=request.getContextPath()%>/promoter/savecreate"  modelAttribute="promoterBean,redeemCodeBean,integralSchemeBean" method="POST" >
						...
						<fieldset
							...
							<p>
                               ...
                               <!-- <textarea name="shareMethod"  hidden="hidden" readonly="readonly"  id="shareMethod" >
                               </textarea>  -->
							</p>
							<p>
								<label>活动方案简述</label>
