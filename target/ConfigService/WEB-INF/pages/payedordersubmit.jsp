...
<body>
	...
	<div class="mainWrap clearfix">
		<div class="sidebar">
			<div class="box">
				...
				<ul>
					...
					<li class="cur"><a href="<%=request.getContextPath()%>/promoter/payedorder">提交已完成订单</a></li>
					<li ><!-- 查看已支付的订单 -->
		...
		<div class="colMain">
			<div class="crumb">
				<span>当前位置：</span> <strong>已完成支付订单提交</strong>
			</div>
		<div class="header">
		...
		<div class="toolbar">
				    <div style="float: left;margin:auto;clear: left;">
		           	 <center><h1><span><img src="<%=request.getContextPath()%>/resources/images/payedorder.png" alt="iDreamsky" title="iDreamsky"></span></h1></center>
                    <br>
                    </div>
                    <div style="float: left;margin:auto;clear: left;">
					 <form method="POST"  enctype="multipart/form-data" id="form1" action="<%=request.getContextPath()%>/promoter/upload">  
					        <table >  
					         <tr >  
					            <td >上传黑名单Excel文件: </td>  
	...
	<script type="text/javascript">
        ...
        $(document).ready(function(){  
           $("#btn").click(function(){  
               if(checkData()){  
                   $("#form1").ajaxSubmit({    
                       url:'<%=request.getContextPath()%>/promoter/ajaxUpload',  
                       //dataType: 'text',  
                       success: resutlMsg,  
                       error: errorMsg  
                   });   
