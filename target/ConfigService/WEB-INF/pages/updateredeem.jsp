...
<body>
	...
	<div class="mainWrap clearfix">
		...
		<div class="colMain">
			...
			<div class="wrap">
				<div class="grid">
					<form id="Form" action="<%=request.getContextPath()%>/redeem/saveupdate"  modelAttribute="userBean" method="POST">
						<fieldset
							...
							<p>
								...
								<input type="hidden" name="id" value="${gameRedeemBean.id }"/>
								<input type="hidden" name="actId" value="${gameRedeemBean.actId }"/>
							</p>
							<p>
								<label >游戏Id</label> 
								<input type="text" class="iText" disabled value="${gameRedeemBean.gameId }" />
								<input type="hidden" class="iText" name="gameId" value="${gameRedeemBean.gameId }" />
							</p>
							<p>
							...
							<p>
								<label>创建时间</label> <input type="text" class="iText" disabled
									name="createTime" value="${gameRedeemBean.getCreateTime(1) }" />
									<input type="hidden" name="createTime" value="${gameRedeemBean.createTime }"/>
							</p>
