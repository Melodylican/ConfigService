...
<body>
	...
	<div class="mainWrap clearfix">
		<div class="sidebar" style="height: 1050px;">
			<div class="box">
				...
				<ul>
					...
					<li ><!-- 查看已支付的订单 -->
					     <a href="<%=request.getContextPath()%>/promoter/payedorderlist">现金兑换玩家列表</a>
					</li>
					<li>
		...
		<div class="colMain">
			...
			<div class="wrap">
				<div class="grid">
					<form id="Form" action="<%=request.getContextPath()%>/promoter/savecreate"  modelAttribute="promoterBean,redeemCodeBean,integralSchemeBean,exchBean" method="POST" >
						<!-- 表单开始标记 -->
