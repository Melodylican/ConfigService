	...
	<div class="mainWrap clearfix">
		...
		<div class="toolbar">
				    <div style="float: left;margin:auto;clear: left;">
		           	 <center><h1><span><img src="<%=request.getContextPath()%>/resources/images/blacklist.png" alt="iDreamsky" title="iDreamsky"></span></h1></center>
                    <br>
                    </div>
                    <div style="float: left;margin:auto;clear: left;">
					 <form method="POST"  enctype="multipart/form-data" id="form1" action="<%=request.getContextPath()%>/promoter/blacklistAjaxUpload">  
					        <table >  
					         <tr >  
					            <td> 
	...
	<script type="text/javascript">
        ...
        $(document).ready(function(){  
           $("#btn").click(function(){  
               if(checkData()){  
                   $("#form1").ajaxSubmit({    
                       url:'<%=request.getContextPath()%>/promoter/blacklistAjaxUpload',  
                       //dataType: 'text',  
                       success: resutlMsg,  
                       error: errorMsg  
                   });   
