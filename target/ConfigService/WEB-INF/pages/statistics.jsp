		...
		<div class="sidebar" style="height: 1650px;">
			<div class="box">
				...
				<ul>
					...
					<li ><a
						href="<%=request.getContextPath()%>/exchange/exchange">现金兑换配置</a></li>
					...
					<li><a
						href="<%=request.getContextPath()%>/promoter/payedorder">提交已完成订单</a></li>
					<c:if
			...
			<div class="wrap">
				<div class="grid" style="background:WhiteSmoke">
					...
					<input type="hidden" name="gameName" value="${gameName}"/>
					    <div style="width: 800px; height: 480px; margin: 0 auto ">
					    ...
					    <div style="width: 800px; height: 580px; margin: 0 auto">
					        <div style="width: 800px; height: 50px; margin: 0 auto ">
						        <p class="fl">
